...
export const CLI_COMMAND = {
  ...
  styleLintReport: () => stringTemplate`./node_modules/.bin/stylelint '${0}' -q -f json > styleCheck-result.json`,
  styleLint: () => stringTemplate`./node_modules/.bin/stylelint '${0}' --custom-formatter=node_modules/stylelint-formatter-table --fix`,
  ...
  mockServer: () => stringTemplate`node ${0}/engine/mock-server/mock.server.js`,
  mockServerWatch: () => stringTemplate`./node_modules/.bin/nodemon ${0}/engine/mock-server/mock.server.js`,
